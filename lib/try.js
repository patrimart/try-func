...
var TryClass = (function () {
    ...
    TryClass.prototype._executeFuncStack = function (resolve, accumulator) {
        ...
        if (!this._funcStack.length) {
            resolve(either_1.default.Right(accumulator));
            return;
        }
        (function (func, acc) {
            try {
                ...
                var Failure_1 = function (e) {
                    resolve(either_1.default.Left(e));
                };
                if (!func.isFork || !!process.env.__TRYJS_IN_FORK) {
                    var r = func.func.call({ Success: Success_1, Failure: Failure_1 }, accumulator);
                    if (r !== undefined) {
                        if (r instanceof either_1.default) {
                ...
                log.error(err);
                resolve(either_1.default.Left(err));
            }
